...
int displayMainMenu() {
    ...
    cout << "=============================================" << endl;
    cout << "1. Shortest Job First (SJF) - Non-preemptive" << endl;
    cout << "2. First Come First Served (FCFS)" << endl;
...
int displayTestMenu(const string& algorithmName) {
    clearScreen();
    cout << "=============================================" << endl;
    cout << "          " << algorithmName << " SCHEDULING" << endl;
    cout << "=============================================" << endl;
    cout << "1. Custom Test - Manual Process Input"<< endl;
    cout << "2. Automated Test - Random Process Generation "<< endl;
...
void runFCFSTest(int testType) {
    ...
    cout << "FCFS Scheduling - Feature Not Yet Implemented\n";
